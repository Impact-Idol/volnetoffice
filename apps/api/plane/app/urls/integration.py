...
URL routing for Impact Idol → VolNetOffice integration endpoints.
All endpoints require service token authentication via X-Api-Key header.
"""
...
urlpatterns = [
    ...
    path(
        ...
        name="integration-permission-sync",
    ),
    ...
    path(
        ...
        name="integration-session-revoke",
    ),
]
